...
setup(
  ...
  url = 'https://github.com/sumitdvlp/NN_From_Scratch',
  python_requires = '>=3.0',
  install_requires = read_requirements('requirements.txt').split('\n'),
  description = 'All popular NN architecture from Scratch.',
  license = 'MIT',
  keywords = 'deep-learning machine-learning ai pytorch python',
